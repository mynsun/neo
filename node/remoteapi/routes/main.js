...
app.get('/Hello', (req, res) => {
    urls = 'http://43.201.98.64:8000/Hello';
...
app.get('/api/users', (req, res) => {
    axios
        .get('http://43.201.98.64:8000/api/users')
        .then(result => {
...
app.get('/api/users/user', (req, res) => {
    if (req.query.name == null) {
        urls = 'http://43.201.98.64:8000/api/users/user?id=' + req.query.id;
    } else {
        urls = 'http://43.201.98.64:8000/api/users/user?id=' + req.query.id + '&name=' + req.query.name;
    }
...
app.get('/api/users/:id', (req, res) => {
    urls = 'http://43.201.98.64:8000/api/users/user?id=' + req.params.id;
...
app.post('/api/users/userBody', (req, res) => {
    const option = {
        uri: 'http://43.201.98.64:8000/api/users/userBody',
        method: 'POST',
        form: { id: req.body.id },
    };
...
app.post('/api/users/add', (req, res) => {
    const option = {
        uri: 'http://43.201.98.64:8000/api/users/add',
        method: 'POST',
...
app.put('/api/users/update', (req, res) => {
    const option = {
        uri: 'http://43.201.98.64:8000/api/users/update/',
        method: 'PUT',
        form: { id: req.body.id, name: req.body.name },
    };
...
app.patch('/api/users/update/:id', (req, res) => {
    const option = {
        uri: 'http://43.201.98.64:8000/api/users/update/' + req.params.id,
        method: 'PATCH',
...
app.delete('/api/users/delete', (req, res) => {
    const option = {
        uri: 'http://43.201.98.64:8000/api/users/delete/',
        method: 'DELETE',
        form: { id: req.body.id },
    };
